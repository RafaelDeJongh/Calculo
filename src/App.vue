...
<div id="app">
	...
	<main id="webcalc">
		...
		<section id="price">
			...
			<h3 id="design-info">Design types</h3>
			...
			<h3 id="speed-info">Build speed</h3>
			...
			<h3 id="page-info">Amount of pages</h3>
			...
			<h3 id="features-info">Features</h3>
...
export default{
	...
	data(){
		return{
			...
			options:{
				sitetype:[
					{text:"Standard",         price:{low:600, high:1000}},
	...
	//Calculate Mimimum Price
		calcMin(){
			...
			var featuresPrice = this.form.features.reduce((state,feature,index,array)=>{
				...
				var speedFeature = this.options.speed.filter(speedCheck => speedCheck.text == feature);
				speedFeature.forEach(speed=>{
